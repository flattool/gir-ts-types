...
declare module 'gi://GstVulkan?version=1.0' {
    ...
    export namespace GstVulkan {
        ...
        class VulkanDecoder extends Gst.Object {
            ...
            /** @signal */
            connect<K extends keyof VulkanDecoder.SignalSignatures>(
                signal: K,
                callback: GObject.SignalCallback<this, VulkanDecoder.SignalSignatures[K]>,
            ): number;
            connect(signal: string, callback: (...args: any[]) => any): number;
            /** @signal */
            connect_after<K extends keyof VulkanDecoder.SignalSignatures>(
                signal: K,
                callback: GObject.SignalCallback<this, VulkanDecoder.SignalSignatures[K]>,
            ): number;
            connect_after(signal: string, callback: (...args: any[]) => any): number;
            /** @signal */
            emit<K extends keyof VulkanDecoder.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<VulkanDecoder.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never
            ): void;
            emit(signal: string, ...args: any[]): void;
