...
export namespace GstVulkan {
    ...
    class VulkanDecoder extends Gst.Object {
         ...
         * @internal
         */
        $signals: VulkanDecoder.SignalSignatures;
        ...
        // Signals
        /** @signal */
        connect<K extends keyof VulkanDecoder.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, VulkanDecoder.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof VulkanDecoder.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, VulkanDecoder.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof VulkanDecoder.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<VulkanDecoder.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;

        // Methods
        /**
         * Appends slices's `data` bitstream into `pic` internal input buffer.
         * @param pic a {@link GstVulkan.VulkanDecoderPicture}
         ...
         */
        append_slice(pic: VulkanDecoderPicture, data: number, size: bigint | number, add_startcode: boolean): boolean;
         ...
         * @param caps the {@link Gst.Caps} of the DP
        ...
        /**
         * Creates a {@link GstVulkan.VulkanImageView} for `buf` for decoding, with the internal Ycbcr
         * sampler, if available.
         * @param buf a {@link Gst.Buffer}
         * @param is_out if `buf` is for output or for DPB
         * @returns the {@link GstVulkan.VulkanImageView}.
         */
         ...
         * @param pic a {@link GstVulkan.VulkanDecoderPicture}
         * @param out the {@link Gst.Buffer} to use as output
         * @returns whether `pic` was initialized.
         */
        picture_init(pic: VulkanDecoderPicture, out: Gst.Buffer): boolean;

        /**
         * @returns the {@link Gst.Caps} of the profile defined at     `gst_vulkan_decoder_start()`.
         */
         ...
         * `error` is filled.
         * @param profile a {@link GstVulkan.VulkanVideoProfile}
         ...
         */
        update_ycbcr_sampler(range: Vulkan.SamplerYcbcrRange, xloc: Vulkan.ChromaLocation, yloc: Vulkan.ChromaLocation): boolean;
    ...
    class VulkanOperation extends Gst.Object {
         ...
         */
        add_frame_barrier(frame: Gst.Buffer, dst_stage: bigint | number, new_access: bigint | number, new_layout: Vulkan.ImageLayout, new_queue: VulkanQueue | null): boolean;
    ...
    class VulkanQueue extends Gst.Object {
        ...
        /**
         * Creates a {@link GstVulkan.VulkanDecoder} object if `codec` decoding is supported by `queue`
         * @param codec the VkVideoCodecOperationFlagBitsKHR to decode
         * @returns the {@link GstVulkan.VulkanDecoder} object
         * @since 1.24
         */
