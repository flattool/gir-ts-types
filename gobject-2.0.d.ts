...
declare module 'gi://GObject?version=2.0' {
    ...
    export namespace GObject {
        ...
        /**
         * Returns whether a {@link GObject.Value} of type `src_type` can be copied into
         * a {@link GObject.Value} of type `dest_type`.
         ...
         * to functions within a {@link GObject.TypeValueTable} structure, or implementations of
        ...
        class Value {
             ...
             * value is the same as an uninitialized (zero-filled) {@link GObject.Value}
             * structure.
             */
            unset(): void;
        }
