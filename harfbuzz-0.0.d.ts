...
export namespace HarfBuzz {
     ...
     * @gir-type Enum
     */
    export namespace ot_bits_tag_t {
        export const $gtype: GObject.GType<ot_bits_tag_t>;
    }
     ...
     * @gir-type Enum
     */
    export namespace ot_number_tag_t {
        export const $gtype: GObject.GType<ot_number_tag_t>;
    }
